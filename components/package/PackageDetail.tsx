...
import PackageSeoContent from "@/components/package/PackageSeoContent";
    ...
    <div className="max-w-7xl mx-auto py-10 px-4 relative">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-10">
        <div className="p-5 border rounded-xl">
          ...
          <p className="font-semibold">{pkg.duration || pkg.days || "Flexible"}</p>
        </div>
        <div className="p-5 border rounded-xl">
        ...
        <div className="p-5 border rounded-xl">
          ...
          <p className="font-semibold">{pkg.category || "Tour Package"}</p>
        </div>
        <div className="p-5 border rounded-xl">
          <p className="text-gray-500">Rating</p>
          <p className="font-semibold">⭐ {pkg.rating ?? 4.8}</p>
        </div>
      </div>

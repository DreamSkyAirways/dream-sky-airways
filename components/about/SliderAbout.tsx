...
export default function AirlineSlider() {
  return (
    <section className="w-full bg-[#0D1B3A] pt-14">
      <div className="mx-auto flex max-w-9xl items-center gap-10 px-4 py-4">
        ...
        <div className="relative flex-1 overflow-hidden">
          {/* fade */}
          <div className="absolute left-0 top-0 z-10 h-full w-16 bg-gradient-to-r from-[#0b1645] to-transparent" />
          <div className="absolute right-0 top-0 z-10 h-full w-16 bg-gradient-to-l from-[#0c0e37] to-transparent" />

...
const PackageForm = ({ isDark = true }: PackageFormProps) => {
      ...
      <form onSubmit={handleSubmit}>
        ...
        >
          ...
          <div
            className={
              isDark
                ? "xl:col-span-4 bg-slate-900/60 backdrop-blur-md border border-white/15 hover:border-white/30 rounded-2xl p-3.5 sm:p-4 text-white shadow-md transition-all"
          ...
          <div
            ...
            className={`relative ${isDark
                ? "xl:col-span-3 bg-slate-900/60 backdrop-blur-md border border-white/15 hover:border-white/30 rounded-2xl p-3.5 sm:p-4 text-white shadow-md transition-all cursor-pointer"
                : "xl:col-span-3 p-3 cursor-pointer"
              }`}
          >
            <div onClick={toggleGuests}>
              ...
              <h2 className={`text-xl sm:text-2xl font-bold ${isDark ? "text-white" : "text-gray-900"}`}>
                {guestInfo.adults + guestInfo.children} Travellers
              </h2>

...
const UpDestinations: React.FC = () => {
  const destinations: DestinationCard[] = [
    {
      id: 1,
      title: "Taj Mahal",
      location: "Agra District",
      description: "Experience sceneric view of taj mahal",
    ...
    },
    {
      ...
      description: "Known for the vrindavan and barsana.",
      image: "/holidaypack/uk.jpeg",
      duration: "4 Days",
      price: "₹14,999"
    },
    {
      ...
      description: "The adventure and spiritual capital of India. yoga retreats, and the sacred Ganges River await you.",
      image: "/holidaypack/uk.jpeg",
      duration: "5 Days",
      price: "₹16,499"
    },
    {
      ...
      title: "Ayodhya",
      location: " Paradise",
      description: "Famous for its pristine slopes and breathtaking views of  Ideal for cable car rides.",
      image: "/holidaypack/uk.jpeg",
      duration: "4 Days",
      price: "₹18,999"
    },
    {
      id: 5,
      title: "Lucknow",
      location: "Gateway to Monuments",
      description: "Witness the magical Monuments. A sacred pilgrimage site known for its spiritual significance and vibrant culture.",
      image: "/holidaypack/uk.jpeg",
      duration: "3 Days",
      price: "₹9,999"
    },
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-cyan-50 py-12 px-4">
      ...
      <div className="max-w-7xl mx-auto text-center mb-12">
        ...
        <h1 className="text-5xl font-bold text-gray-900 mb-4 tracking-tight">
          Discover Uttar Pardesh
        </h1>
        <p className="text-xl text-gray-600 max-w-2xl mx-auto">
          Explore the majestic Areas with our curated holiday packages. 
          From serene  to thrilling adventures — create memories that last forever.
        </p>
      </div>
